...
public class Ui_Settings implements com.trolltech.qt.QUiForm<QDialog> {
	...
	private void setupSystemTray() {
		if (QSystemTrayIcon.isSystemTrayAvailable()) {
			...
			QAction toggleVisibilityAction = new QAction("Show/Hide", qDialog);
			trayIconMenu.addAction(toggleVisibilityAction);

			QAction restoreAction = new QAction("Restore",qDialog);
			trayIconMenu.addAction(restoreAction);

			QAction minimizeAction = new QAction("Minimize",qDialog);
			trayIconMenu.addAction(minimizeAction);

			QAction maximizeAction = new QAction("Maximize",qDialog);
			trayIconMenu.addAction(maximizeAction);

			trayIconMenu.addSeparator();

			QAction quitAction = new QAction("&Quit", qDialog);
			trayIconMenu.addAction(quitAction);
			trayIcon = new QSystemTrayIcon(qDialog);
